...
- [x] **Step 1 — `retrospective-guide.md` 재작성** (model: opus) ✅ 2026-04-18T14:40 KST
...
- [x] **Step 2 — `patrol.md` 실행 순서 갱신** (model: sonnet) ✅ 2026-04-18T14:42 KST (agent a77108cc)
...
- [x] **Step 3 — `.ruler/scripts/retrospective-collect.sh` Δ 수집 + verdict 통합** (model: sonnet) ✅ 2026-04-18T14:54 KST (agent a0b6e639)
...
- [x] **Step 5 — `~/.claude/skills/ruler-wf/skill.md` §5b 보완** (model: sonnet) ✅ 2026-04-18T14:43 KST (agent ab8f3e57)
...
- [x] **Step 6 — `~/.claude/skills/audit-wf/skill.md` Phase Final-B 재정의** (model: opus) ✅ 2026-04-18T14:45 KST (agent aa852283)
...
- [x] **Step 7 — Smoke test + verdict 오탐 1차 리뷰** (model: sonnet) ✅ 2026-04-18T14:55 KST (구조 검증 PASS, 실측은 observation-only 4주 후)
...
- [x] **Step 8 — `patrol-tier-c.md §C_external` 항목 추가** (model: sonnet) ✅ 2026-04-18T14:45 KST (agent ae017d31)

...
- [ ] **Step 7** — 비서 재시작 안내 — 사용자 수동. Step 1 반영은 server.js kill + 재구동 또는 `curl -X POST http://localhost:9876/restart` 필요. **미반영 시 L1595 구버전 코드가 여전히 5-6분 주기 wake-stop 찍음 (11회 관측됨)**
